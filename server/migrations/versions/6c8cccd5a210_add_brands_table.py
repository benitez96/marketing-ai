...
def upgrade() -> None:
    ...
    sa.Column('mission_statement', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('best_selling_products', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('prompt', sa.Column('chat_id', sa.INTEGER(), autoincrement=False, nullable=False))
